...
//This class is going to hold a JSON response
//from grabbing the eather via API
//THe names and types of the variables i it
// Must match the names and type fo the variables in 
